...
Утверждена только организация документации. ADR остаются `proposed`, спецификация — `review-ready`; статус реализации каждого этапа указан в плане и не означает принятия предлагаемого контракта.

## Текущий пакет

- [Спецификация: unit economics и lifecycle](specs/2026-09-21-unit-economics-and-session-lifecycle.md), v1.1, `review-ready`.
- [План: шесть этапов](plans/2026-09-21-unit-economics/README.md): этапы 1–4 завершены, этап 5 выполняется в feature branch, этап 6 запланирован.
