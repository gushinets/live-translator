...
| §11 limiter/config/reservations | 1: create/admission config; 2: worker config (`concurrency=2`, `batch=20`), durable admission/startup recovery/orphan cleanup; 4: normal release boundary; 6: reconciliation/report only |
